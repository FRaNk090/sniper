...
#define SimMagic3(cmd, arg0, arg1) ({        \
   unsigned long _cmd = (cmd), _arg0 = (arg0), _arg1 = (arg1), _res = 0; \
   __asm__ __volatile__ (                    \
   "mov %2, %0\n"                            \
   "add %3, %0\n"                            \
   : "=a" (_res)           /* output    */   \
...
// //  adding 2 list of numbers
// #define SimMagic3(cmd, arg0, arg1, arg2, arg3) ({                                                    \
//    unsigned long _cmd = (cmd), _arg3 = (arg3), _res; \
//    int *_arg0 = (arg0), *_arg1 = (arg1), *_arg2 = (arg2); \
//    __asm__ __volatile__(                                                                             \
//        "\tloop1: mov 0, %%" MAGIC_REG_A "\n"                                                          \
//        "\tmov %2(, %%" MAGIC_REG_A ", 4), %%" MAGIC_REG_C "\n"                                          \
//        "\tadd %3(, %%" MAGIC_REG_A ", 4), %%" MAGIC_REG_C "\n"                                          \
//        "\tmov %%" MAGIC_REG_C ", %4(, %%" MAGIC_REG_A ", 4)\n" \
//        "\tinc %%" MAGIC_REG_A "\n" \
//        "\tcmp %%" MAGIC_REG_A ", %5\n" \
//        "\tjle loop1\n" \
//        : "=a"(_res) /* output    */                                                                  \
